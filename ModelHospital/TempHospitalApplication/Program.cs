...
namespace TempHospitalApplication
{
    ...
    class Program
    {
        ...
        //public static void FillMedicalSpecialty()
        //{
        //    MedicalSpecialty.MedicalSpecialtyList.Add("PEDIATOR");
        //    MedicalSpecialty.MedicalSpecialtyList.Add("CHIRURG");
        //    MedicalSpecialty.MedicalSpecialtyList.Add("REANIMATOLOG");
        //    MedicalSpecialty.MedicalSpecialtyList.Add("LOR");
        //    MedicalSpecialty.MedicalSpecialtyList.Add("CARDIOLOG");
        //    MedicalSpecialty.MedicalSpecialtyList.Add("GASTROLOG");
